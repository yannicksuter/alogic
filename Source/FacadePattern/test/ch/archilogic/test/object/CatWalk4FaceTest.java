...
public class CatWalk4FaceTest extends TestCase {
	public static ObjectDef createObject4Face(ObjectVector p) throws FaceException {
		...
		Face f3 = new Face();
		f3.addVertice(new ObjectVector(10,0,0));
		f3.addVertice(p);
		f3.addVertice(new ObjectVector(20,10,0));
		obj.addFace(f3);

		Face f4 = new Face();
		f4.addVertice(new ObjectVector(10,0,0));
		f4.addVertice(new ObjectVector(20,10,0));
		f4.addVertice(new ObjectVector(20,0,0));
		obj.addFace(f4);
	...
	public void testIntersection1_4Face() throws FaceException{
		...
		ObjectVector p = new ObjectVector(10,10,0);
	...
	public void testIntersection2_4Face() throws FaceException{
		...
		ObjectVector p = new ObjectVector(11,10,0);
		ObjectDef o = createObject4Face(p);
	...
	public void testIntersection3_4Face() throws FaceException{
		...
		ObjectVector p = new ObjectVector(9,10,0);
		ObjectDef o = createObject4Face(p);
